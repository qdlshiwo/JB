		...
		<div class="container">
			...
			<header class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="row">
							...
							<nav class="col-lg-5 col-md-5 col-sm-5">
								<ul class="pull-right">
									...
									<li><a href="#">$ US Dollar <i class="icons icon-down-dir"></i></a>
                                    	<ul class="box-dropdown parent-arrow">
											<li>
                                            	<div class="box-wrapper no-padding parent-border">
					...
					<!-- Main Navigation -->
					<nav id="main-navigation" class="style6">
						<ul>
			...
			style="width:100px; height:20px;"></iframe>
											...
											<a href="/www.pinterest.com/pin/create/button/?url=http%3A%2F%2Fwww.flickr.com%2Fphotos%2Fkentbrew%2F6851755809%2F&media=http%3A%2F%2Ftest.ratkosolar.com%2Fhomeshop%2F15-blog_post.jsp&description=Next%20stop%3A%20Pinterest" data-pin-do="buttonPin" data-pin-config="beside" class="pinterest"><img src="/assets.pinterest.com/images/pidgets/pinit_fg_en_rect_gray_20.png" /></a>
