                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="blog-item">
                                ...
                                <img src="img/blog/sample1.jpg" alt="">
                                <div class="blog-info">
                                    <div class="blog-meta">
                                    ...
                                    <p>Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. Sed laoreet aliquam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. <br><br>
Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla. Donec porta diam eu massa. Quisque diam lorem, interdum vitae,dapibus ac, scelerisque vitae, pede. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus.Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla. <br><br>
Donec porta diam eu massa. Quisque diam lorem, interdum vitae,dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat lacinia fermentum. Donec in velit vel ipsum auctor pulvinar. Vestibulum iaculis lacinia est. Proin dictum elementum velit. Fusce euismod consequat ante. Lorem ipsum dolor sit amet, consectetuer adipisMauris accumsan nulla vel diam. Sed in lacus ut enim adipiscing aliquet. Nulla venenatis. In pede mi, aliquet sit amet, euismod in,auctor ut, ligula. Aliquam dapibus tincidunt metus. Praesent justo dolor, lobortis quis, lobortis dignissim, pulvinar ac, lorem. Vestibulum sed ante. </p>
        ...
        src="https://platform.twitter.com/widgets/tweet_button.jsp"
        style="width:100px; height:20px;"></iframe>
                                        ...
                                        <a href="/www.pinterest.com/pin/create/button/?url=http%3A%2F%2Fwww.flickr.com%2Fphotos%2Fkentbrew%2F6851755809%2F&media=http%3A%2F%2Ftest.ratkosolar.com%2Fhomeshop%2F15-blog_post.jsp&description=Next%20stop%3A%20Pinterest" data-pin-do="buttonPin" data-pin-config="beside"><img src="/assets.pinterest.com/images/pidgets/pinit_fg_en_rect_gray_20.png" /></a>
								...
								<div class="product-actions blog-actions-big">
									...
									<span class="product-action red">
										<span class="action-wrapper">
											...
											<span class="action-name">Print page</span>
										</span>
									</span>
									<span class="product-action home-green">
										<span class="action-wrapper">
											<i class="icons icon-mail"></i>
											<span class="action-name">Send email</span>
										</span>
									</span>
								</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="page-content">
                            	<ul>
                                	<li><a href="#"><i class="icons icon-right-dir"></i> Ullamcorper Phasellus ullamcorper blandit leo, id pharetra leo</a></li>
                                    <li><a href="#"><i class="icons icon-right-dir"></i> Ullamcorper Phasellus ullamcorper blandit leo, id pharetra leo</a></li>
                                    <li><a href="#"><i class="icons icon-right-dir"></i> Ullamcorper Phasellus ullamcorper blandit leo, id pharetra leo</a></li>
                                    <li><a href="#"><i class="icons icon-right-dir"></i> Ullamcorper Phasellus ullamcorper blandit leo, id pharetra leo</a></li>
                                    <li><a href="#"><i class="icons icon-right-dir"></i> Ullamcorper Phasellus ullamcorper blandit leo, id pharetra leo</a></li>
                            ...
                            <div class="page-content-footer">
                            	<p>More in this category: <a href="#">Category name goes here <i class="icons icon-right-dir"></i></a></p>
                            </div>
                    	</div>
                            ...
                            <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-8">
                                        ...
                                        <textarea></textarea>
                                        <br><br>
                                        <input type="checkbox"><label>Notify me of follow-up comments</label>
                                        <br><br>
