				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div id="main-header" class="style5">
						...
						<div class="row">
							...
							<nav id="middle-navigation" class="col-lg-8 col-md-8 col-sm-8">
								<ul class="pull-right">
									<li class="blue">
										<a href="compare_products.jsp"><i class="icons icon-docs"></i>0 Items</a>                                    </li>
									<li class="red">
										<a href="wishlist.jsp"><i class="icons icon-heart-empty"></i>2 Items</a>                                    </li>
                                    	...
                                    	<ul id="cart-dropdown" class="box-dropdown parent-arrow">
											<li>
                                                    ...
                                                    <table class="cart-table">
                                                    	<tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#" class="parent-color">Remove</a>                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    		<td><img src="img/products/sample1.jpg" alt="product"></td>
                                                            <td>
                                                ...
                                                <div class="box-wrapper no-border">
													...
													<a class="button pull-right" href="order_info.jsp">View Cart</a>                                                </div>
											</li>
										</ul>
                                    </li>
					...
					<nav id="main-navigation" class="style5">
						<ul>
							...
							<li class="nav-search">
                                	<i class="icons icon-search-1"></i>							</li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        	<div class="category-heading">
                                ...
                                <div class="category-buttons">
									<a href="category_v1.jsp"><i class="icons icon-th-3"></i></a>
									<a href="category_v2.jsp"><i class="icons icon-th-list-4 active-button"></i></a>
								</div>
							</div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="grid-view product">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 product-content no-padding">
                                	<div class="product-info">
                                        <h5><a href="products_page_v1.jsp"><%=s.getPname() %></a></h5>
