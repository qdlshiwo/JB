											...
											<li>
												...
												<c:if test=" ${loginstate eq 0 }">
													...
													<div class="pull-right">
														<a href="../create_an_account.jsp">Forgot your password?</a> <br> <a
															href="../create_an_account.jsp">Forgot your username?</a> <br>
													</div>
													<br class="clearfix">
													<div class="footer">
														<h4 class="pull-left">NEW CUSTOMER?</h4>
														<a class="button pull-right" href="../create_an_account.jsp">Create
														an account</a>
													</div>
												</c:if>
