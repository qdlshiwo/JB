...
<BODY>
	<SCRIPT type=text/javascript>
		...
		function openChat() {
			alert("打开");
			window.open("chat/index.htm", "", "left=250   top=200   width=500   height=400");
		}
	</SCRIPT>
								...
								<TD width=352>
									<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
										<TBODY>
											...
											<TR>
												<TD colSpan=2><IMG height=1 src="image/d03.jpg"
													width=352></TD>
											</TR>
											<TR>
												<TD colSpan=2 height=26>&nbsp;<A class=dong06
									...
									<TABLE cellSpacing=0 cellPadding=0 width=287 align=center
										...
										<TBODY>
											...
											<TR>
												...
												<TD align=middle width=97 height=47><IMG height=33
													src="image/d_r11_13_r1_c7.jpg" width=88></TD>
											</TR>
										</TBODY>
									</TABLE>
								</TD>
							...
							<TR>
								<TD height=590>
									...
									<DIV id=demo
										...
										<DIV id=demo1>
											<!-- 定义图片 -->
											<IMG height=107 src="image/d_r11_10_r1_c1.jpg" width="100%"
												align=middle border=0> <IMG height=107
												src="image/d_r11_10_r1_c8.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c16.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c22.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c2.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c81.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c116.jpg" width="100%" align=middle
												border=0> <IMG height=107
												src="image/d_r11_10_r1_c221.jpg" width="100%" align=middle
												border=0>
										</DIV>
										<DIV id=demo2></DIV>
									</DIV> <SCRIPT>
										...
										function Marquee() {
											if (demo1.offsetTop - demo.scrollTop >= 0)
												demo.scrollTop += demo2.offsetHeight;else {
												demo.scrollTop--;
											}
										}
