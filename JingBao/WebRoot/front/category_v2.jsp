					...
					<div id="main-header" class="style5">
						...
						<div class="row">
							...
							<nav id="middle-navigation" class="col-lg-8 col-md-8 col-sm-8">
								<ul class="pull-right">
									<li class="blue">
										<a href="compare_products.html"><i class="icons icon-docs"></i>0 Items</a>                                    </li>
									<li class="red">
										<a href="wishlist.html"><i class="icons icon-heart-empty"></i>2 Items</a>                                    </li>
                                    	...
                                    	<ul id="cart-dropdown" class="box-dropdown parent-arrow">
											<li>
                                                ...
                                                <div class="box-wrapper no-border">
													...
													<a class="button pull-right" href="order_info.html">View Cart</a>                                                </div>
											</li>
										</ul>
                                    </li>
